...
del *.ova
del *.box
vboxmanage export vagrant-ubuntu-14.04-rancher -o vagrant-ubuntu-14.04-rancher-%version%.ova
if errorlevel 1 goto error

rem create & push vagrant box
:retry
packer build -force -var 'version=%version%' -var 'token=%ATLAS_TOKEN%' packer-vagrant-ubuntu-14.04-rancher.json
